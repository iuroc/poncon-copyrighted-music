...
for ($x = 0; $x < count($fromData); $x++) {
    $item = $fromData[$x];
    $insert_sql = "INSERT INTO `copyrighted_music` (`fileName`, `size`, `fileId`, `etag`, `s3keyFlag`, `type`, `msg`, `time`, `downloadUrl`, `musicType`, `url_update_time`, `like_num`, `collect_userList`)" .
